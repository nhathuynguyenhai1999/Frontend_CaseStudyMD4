...
import com.example.casestudylibrary.config.service.JwtResponse;
import com.example.casestudylibrary.config.service.JwtService;
...
public class AuthAPI {
    ...
    @PostMapping("/login")
    public ResponseEntity<?> login(@RequestBody UserReqDto user) {
